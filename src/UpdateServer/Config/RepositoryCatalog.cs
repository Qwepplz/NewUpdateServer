...
namespace UpdateServer.Config
{
    internal static class RepositoryCatalog
    {
        ...
        public static readonly RepositoryTarget PugRepository = new RepositoryTarget("pug", "pug", GithubOwner, "pug", MirrorOwner, "pug");
        public static readonly RepositoryTarget Get5Repository = new RepositoryTarget("get5", "get5", GithubOwner, "get5", MirrorOwner, "get5");
